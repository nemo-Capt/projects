...
public class TriangleParamTestPerimeter {
    private double x1;
    private double x2;
    private double x3;
    private double y1;
     ...
     * @param expected ожидаемый периметр
     */
    public TriangleParamTestPerimeter(double x1, double x2, double x3, double y1, double y2, double y3, double expected) {
        this.x1 = x1;
        this.x2 = x2;
        this.x3 = x3;
        this.y1 = y1;
    ...
    public static Collection values() {
        return Arrays.asList(new Object[][]{
                {0, 0, 3, 0, -4, -4, 12},
                {0, 0, 0, 0, 0, 0, 0},
                {2, 3, 4, 5, -6, -7, 24.625099640156794},
                {-5, -5, 4, 0, -10, -10, 32.45362404707371},
                {1, 1, 2, 2, -3, -3, 11.099019513592784}
        });
    }

    @Test
    public void perimeterCheck() {
        Assertions.assertEquals(expected, TriangleUtility.findPerimeter(x1, x2, x3, y1, y2, y3));
    }
